...
class OsController extends Controller
{
    public function create(){
        ...
        return view('os.cadastar',['clientes'=>$clientes]);
    }
    ...
    public function store(Request $request){
        ...
        public function edit($id){
            ...
            $proprietario = Clientes::where('id', '=',$os->idcliente)->first();

            return view('os.edit',['os'=>$os, 'clientes'=>$clientes, 'proprietario'=>$proprietario]);
        }
